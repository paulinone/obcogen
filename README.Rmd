...
One caveat. That I am hoping to find a work around for. I have noticed that R can only have so characters or lines that represent a line of code. If you put `code_gen(iris)`. You will get a whole string, but if you paste it directly R will not evaulate it properly. I found out I had to create a new line of code for the "Species" variable.
